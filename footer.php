<style id="onetrust-style">
	...
	.ot-floating-button__front {
		background-image: url('https://cookie-cdn.cookiepro.com/logos/static/ot_persistent_cookie.png')
	}
...
<div id="onetrust-banner-sdk" class="otFlat bottom ot-wo-title vertical-align-content" tabindex="0" style="bottom: 0px; display: none;">
		...
		<div class="ot-sdk-container">
			<div class="ot-sdk-row">
				...
				<div id="onetrust-button-group-parent" class="ot-sdk-three ot-sdk-columns has-reject-all-button">
					<div id="onetrust-button-group"><button id="onetrust-pc-btn-handler" data-toggle="modal" data-target="#onetrust-pc-sdk">Cookies Settings</button>
...
<div id="onetrust-pc-sdk" class="otPcCenter ot-fade-in modal" aria-modal="true" role="alertdialog" aria-describedby="ot-pc-desc" lang="en" aria-label="Privacy Preference Center" style="height: 743.2px;"><!-- Close Button -->
	<div class="ot-pc-header"><!-- Logo Tag -->
		<button id="close-pc-btn-handler" class="ot-close-icon close" data-dismiss="modal" aria-label="Close" tabindex="0"></button>
	</div><!-- Close Button -->
	<div id="ot-pc-content" class="ot-pc-scrollbar ot-enbl-chr">
		...
		<div id="ot-pc-desc">When you visit any website, it may store or retrieve information on your browser, mostly in the form of cookies. This information might be about you, your preferences or your device and is mostly used to make the site work as you expect it to. The information does not usually directly identify you, but it can give you a more personalized web experience. Because we respect your right to privacy, you can choose not to allow some types of cookies. Click on the different category headings to find out more and change our default settings. However, blocking some types of cookies may impact your experience of the site and the services we are able to offer.
			<br>
		</div><button id="accept-recommended-btn-handler" style="display: none;" tabindex="0">Allow All</button>
		<section class="ot-sdk-row ot-cat-grp">
			<h3 id="ot-category-title"> Manage Consent Preferences</h3>
			<div class="ot-accordion-layout ot-cat-item ot-vs-config" data-optanongroupid="C0001"><button aria-expanded="false" ot-accordion="true" aria-controls="ot-desc-id-C0001" aria-labelledby="ot-header-id-C0001"></button><!-- Accordion header -->
				<div class="ot-acc-hdr ot-always-active-group">
					...
					<div class="ot-arw-cntr"><svg class="ot-arw" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="caret-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512">
			...
			<div class="ot-accordion-layout ot-cat-item ot-vs-config" data-optanongroupid="C0002"><button aria-expanded="false" ot-accordion="true" aria-controls="ot-desc-id-C0002" aria-labelledby="ot-header-id-C0002"></button><!-- Accordion header -->
				<div class="ot-acc-hdr">
					...
					<div class="ot-tgl"><input type="checkbox" name="ot-group-id-C0002" id="ot-group-id-C0002" aria-checked="true" role="switch" class="category-switch-handler" data-optanongroupid="C0002" checked="" aria-labelledby="ot-header-id-C0002" tabindex="0"> <label class="ot-switch" for="ot-group-id-C0002"><span class="ot-switch-nob" aria-checked="false" role="switch"></span> <span class="ot-label-txt">Performance Cookies</span></label> </div>
					<div class="ot-arw-cntr"><svg class="ot-arw" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="caret-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512">
							<path fill="currentColor" d="M166.9 264.5l-117.8 116c-4.7 4.7-12.3 4.7-17 0l-7.1-7.1c-4.7-4.7-4.7-12.3 0-17L127.3 256 25.1 155.6c-4.7-4.7-4.7-12.3 0-17l7.1-7.1c4.7-4.7 12.3-4.7 17 0l117.8 116c4.6 4.7 4.6 12.3-.1 17z"></path>
						</svg></div>
				</div><!-- accordion detail -->
			...
			<div class="ot-accordion-layout ot-cat-item ot-vs-config" data-optanongroupid="C0004"><button aria-expanded="false" ot-accordion="true" aria-controls="ot-desc-id-C0004" aria-labelledby="ot-header-id-C0004"></button><!-- Accordion header -->
				<div class="ot-acc-hdr">
					<h4 class="ot-cat-header" id="ot-header-id-C0004">Targeting Cookies</h4>
					<div class="ot-tgl"><input type="checkbox" name="ot-group-id-C0004" id="ot-group-id-C0004" aria-checked="true" role="switch" class="category-switch-handler" data-optanongroupid="C0004" checked="" aria-labelledby="ot-header-id-C0004" tabindex="0"> <label class="ot-switch" for="ot-group-id-C0004"><span class="ot-switch-nob" aria-checked="false" role="switch"></span> <span class="ot-label-txt">Targeting Cookies</span></label> </div>
					<div class="ot-arw-cntr"><svg class="ot-arw" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="caret-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512">
							<path fill="currentColor" d="M166.9 264.5l-117.8 116c-4.7 4.7-12.3 4.7-17 0l-7.1-7.1c-4.7-4.7-4.7-12.3 0-17L127.3 256 25.1 155.6c-4.7-4.7-4.7-12.3 0-17l7.1-7.1c4.7-4.7 12.3-4.7 17 0l117.8 116c4.6 4.7 4.6 12.3-.1 17z"></path>
						</svg></div>
				</div><!-- accordion detail -->
		...
		<div id="ot-pc-hdr">
			...
			<div class="ot-lst-subhdr">
				<div class="ot-search-cntr">
					<p role="status" class="ot-scrn-rdr"></p><label for="vendor-search-handler" class="ot-scrn-rdr"></label> <input id="vendor-search-handler" type="text" name="vendor-search-handler" tabindex="0"> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 -30 110 110" aria-hidden="true">
						...
						<div class="ot-fltr-scrlcnt ot-pc-scrollbar">
							<div class="ot-fltr-opts">
								<div class="ot-fltr-opt">
									<div class="ot-chkbox"><input id="chkbox-id" type="checkbox" aria-checked="false" class="category-filter-handler" tabindex="0"> <label for="chkbox-id"><span class="ot-label-txt">checkbox label</span></label> <span class="ot-label-status">label</span></div>
								</div>
							</div>
			...
			<div id="ot-sel-blk">
				<div class="ot-sel-all">
					...
					<div class="ot-sel-all-chkbox">
						<div class="ot-chkbox" id="ot-selall-hostcntr"><input id="select-all-hosts-groups-handler" type="checkbox" aria-checked="false" tabindex="0"> <label for="select-all-hosts-groups-handler"><span class="ot-label-txt">checkbox label</span></label> <span class="ot-label-status">label</span></div>
						<div class="ot-chkbox" id="ot-selall-vencntr"><input id="select-all-vendor-groups-handler" type="checkbox" aria-checked="false" tabindex="0"> <label for="select-all-vendor-groups-handler"><span class="ot-label-txt">checkbox label</span></label> <span class="ot-label-status">label</span></div>
						<div class="ot-chkbox" id="ot-selall-licntr"><input id="select-all-vendor-leg-handler" type="checkbox" aria-checked="false" tabindex="0"> <label for="select-all-vendor-leg-handler"><span class="ot-label-txt">checkbox label</span></label> <span class="ot-label-status">label</span></div>
					</div>
				</div>
			</div>
			<div class="ot-sdk-row">
	...
	<div class="ot-pc-footer">
		<div class="ot-btn-container"><button class="ot-pc-refuse-all-handler" tabindex="0">Reject All</button> <button class="save-preference-btn-handler onetrust-close-btn-handler" tabindex="0">Confirm My Choices</button></div><!-- Footer logo -->
	</div><!-- Cookie subgroup container --><!-- Vendor list link --><!-- Cookie lost link --><!-- Toggle HTML element --><!-- Checkbox HTML --><!-- plus minus--><!-- Arrow SVG element --><!-- Accordion basic element --><span class="ot-scrn-rdr" aria-atomic="true" aria-live="polite">Your Privacy [`dialog closed`]</span><!-- Vendor Service container and item template --><iframe class="ot-text-resize" title="onetrust-text-resize" style="position: absolute; top: -50000px; width: 100em;" aria-hidden="true"></iframe>
</div>
<footer class="bg-light text-dark py-2 mt-3">
	<div class="container">
		<div class="row">
			<div class="col-md-4 col-12">
				<img src="assets/img/logo2.png" alt="" class="img-fluid">
				<i class="fa fa-map-marker mt-4"> <span class="ml-3">8718 Bay Pkwy,7th Floor, Brooklyn, NY 11214</span></i>
				<hr>
				<a href="mailto:Team@ProLifeHC.com" class="text-dark"><i class="fa fa-envelope mt-1"></i><span class="ml-3">Team@ProLifeHC.com</span></a>
				<hr>
				<a href="tel:718-232-2777" class="text-dark"><i class="fa fa-phone mt-1"></i><span class="ml-3 text-dark">(718)232-2777</span></a> <span class="float-right text-dark" href="#" class="text-dark" style="color:#343a40;"><img src="assets/img/icon-fax.png" style="width:18px;"><span class="ml-3 text-dark">(718)232-2778</span></span>
				<hr>
				<div class="d-flex text-sm-center p-sm-0">
					<h6 style="padding-top:0.75rem;">FOLLOW US</h6>

					<div class="col-md-2 col-sm-6 text-right">
						<a href="https://www.facebook.com/ProLife-Home-Care-Inc-101070611971780"><img src="assets/img/facebook.png" style="width: 2rem;" alt="" class="img-fluid"></a>
					</div>
					<div class="col-md-2 col-sm-6 text-left">
						<a href="https://www.instagram.com/prolife.home.care/"><img src="assets/img/icon-ig.png" style="width: 2rem;" alt="" class="img-fluid"></a>
					</div>
				</div>
			</div>
			<div class="col-md-4 col-12 mt-md-0 mt-5  pb-md-0 pb-4">
				<h5><strong>MORE RESOURCES</strong></h5>
				<div class="row pt-md-5 pt-1">
					<div class="class-md-2">
						<h4 class="bg-text mx-1 p-1"><a href="index.php" class="bg-text">About Us</a></h4>
					</div>
					<div class="class-md-2">
						<h4 class="bg-text mx-1 p-1"><a href="CDPAP.php" class="bg-text">CDPAP</a></h4>
					</div>
					<div class="class-md-2">
						<h4 class="bg-text mx-1 p-1"><a href="contact.php" class="bg-text">Contact</a></h4>
					</div>
					<div class="class-md-1">
						<h4 class="bg-text mx-1 p-1"><a href="faq.php" class="bg-text">FAQ</a></h4>
					</div>
					<div class="class-md-2">
						<h4 class="bg-text mx-1 p-1"><a href="blog.php" class="bg-text">Blog</a></h4>
					</div>
				</div>
				<div class="row pt-2">
					<div class="class-md-4">
						<h4 class="bg-text mx-1 p-1"><a href="home-care-services.php" class="bg-text">Home Care Services</a></h4>
					</div>
					<div class="class-md-4">
						<h4 class="bg-text mx-1 p-1"><a href="service-inhome.php" class="bg-text">In Home Health Care</a></h4>
					</div>
					<div class="class-md-2">
						<h4 class="bg-text mx-1 p-1"><a href="service-livein.php" class="bg-text">Live In Home Care</a></h4>
					</div>
				</div>
				<div class="row pt-2">
					<div class="class-md-4">
						<h4 class="bg-text mx-1 p-1"><a href="service-privatehome.php" class="bg-text">Private Home Care & Nursing</a></h4>
					</div>
					<div class="class-md-2">
						<h4 class="bg-text mx-1 p-1"><a href="service-alzheimers.php" class="bg-text">Alzheimer’s & Dementia Care</a></h4>
					</div>
				</div>
				<div class="row pt-2">
					<div class="class-md-4">
						<h4 class="bg-text mx-1 p-1"><a href="employment.php" class="bg-text">Become a Caregiver</a></h4>
					</div>
					<div class="class-md-2">
						<h4 class="bg-text mx-1 p-1"><a href="employment.php" class="bg-text">Become A CDPAP Personal Assistant</a></h4>
					</div>
				</div>
			</div>
			<div class="col-md-4 ">
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3029.044910985853!2d-73.9904813850991!3d40.60683275198059!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24503508ce455%3A0x5b59e11773a67c2f!2sPROLIFE%20HOME%20CARE%2C%20INC.!5e0!3m2!1sen!2sin!4v1620758524811!5m2!1sen!2sin" width="360" height="330" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
			</div>
		</div>
	</div>
	<hr>
	<h6 class="text-center">&copy; 2021 ProLife Home Care,Inc</h6>
</footer>